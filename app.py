...
if st.button("Generate Sketch"):
    if user_prompt.strip():
            ...
            with st.spinner("Creating your sketch..."):
                try:
                    ...
                    create_res = client.v1.ai_image_generator.create(
                        input_text=f"black and white sketch: {enhanced_prompt}",  # Replaced 'description' with 'input_text'
        ...
        st.warning("Please enter a description for your sketch.")import os
import streamlit as st
from magic_hour import Client
import time
from dotenv import load_dotenv
